...
describe('Albumlist', () => {
  it('should exist renderAlbum method', () => {
  ...
  it('should create and append a markup given the correct data', () => {
  ...
  it('should create and append a markup given when more than 1 data', () => {
